...
<head>
  <meta charset="UTF-8">
  <title>chickenattract-FINAL</title>
...
<div id="app1">
  <div class="container">
    <div class="group">
      ...
      <div class="main">
        <div class="white"></div>
        <div class="navbar"><img class="extra" v-on:click="extra()" src="https://upload.cc/i/OjWEz3.png"/><img class="title" src="https://upload.cc/i/5OToyW.png"/><img class="buttonr" src="https://upload.cc/i/pUT7dA.png" v-on:click="alertrandom()"/><img class="buttond" src="https://upload.cc/i/F1hpDd.png" v-on:click="distanceout()"/></div>
        <div class="distancebar">
          <div class="button1" v-on:click="walk()">走路15分鐘內</div>
          <div class="button2" v-on:click="mot()">騎/開車15分鐘內</div>
          <div class="button3" v-on:click="mot()">騎/開車30分鐘內</div>
          ...
          <div class="for" v-for="(id,photo) in photos">
            ...
            <div class="content" v-if="id==content_id">
              ...
              <div class="distancealert">
                ...
                <div class="title nowait">您現在正位於 台北市徐州路2號 台大醫院</div>
        ...
        <div class="footer" v-if="content_flag==0"><a class="block" href="https://gift624.herokuapp.com/"><img class="gift" src="https://upload.cc/i/Cjlr56.png"/></a>
          ...
          <div class="block" v-on:click="alert()"><img class="search" id="search" src="https://upload.cc/i/SbH9AU.png"/></div><a class="block" href="https://person624.herokuapp.com/"><img class="person" src="https://upload.cc/i/RzTFog.png"/></a>
        </div>
